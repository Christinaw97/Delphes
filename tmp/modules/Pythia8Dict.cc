...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::PileUpMergerPythia8*)0x0)->GetClass(); }
   return fgIsA;
}
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("Pythia8Dict",
        ...
        TriggerDictionaryInitialization_Pythia8Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
