  ...
  TStopwatch *readStopWatch, TStopwatch *procStopWatch)
{
  ...
  for(i = 1; i < pythia->event.size(); ++i)
  {
    ...
    candidate->DecayPosition.SetXYZT(particle.xDec(), particle.yDec(), particle.zDec(), particle.tDec());// decay position
    ...
    if(status == 1)
    {
      ...
      // cout<<pid<<endl;
      // cout<<candidate->InitialPosition.X()<<", "<<candidate->InitialPosition.Y()<<", "<<candidate->InitialPosition.Z()<<endl;
      // cout<<candidate->Position.X()<<", "<<candidate->Position.Y()<<", "<<candidate->Position.Z()<<endl;
      // cout<<candidate->InitialPosition.Eta()<<", "<<candidate->InitialPosition.Phi()<<", "<<candidate->Position.Eta()<<", "<<candidate->Position.Phi()<<", "<<candidate->Momentum.Eta()<<", "<<candidate->Momentum.Phi()<<endl;
